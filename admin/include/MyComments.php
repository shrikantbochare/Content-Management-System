    ...
    <tbody>
        <?php
         ...
         while($row = mysqli_fetch_assoc($disply_comments))
         {
            ...
            echo "<td><a href ='comments.php?source=Mycomments&approve={$comment_id}'>Approve </a> </td>";
            echo "<td><a href ='comments.php?source=Mycomments&unapprove={$comment_id}'>UnApprove </a> </td>";
            echo "<td><a href ='comments.php?source=Mycomments&delete={$comment_id}&post_id={$comment_post_id}'>DELETE </a></td>";
...
if(isset($_GET['approve']))
{
    ...
    confirmQuery($stmt8);
    redirect("comments.php?source=Mycomments");
